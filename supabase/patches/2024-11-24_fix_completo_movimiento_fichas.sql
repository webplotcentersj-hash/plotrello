-- ============================================
-- FIX COMPLETO: Las fichas duplicadas no se mueven - vuelven al estado anterior
-- 
-- Este script consolida todas las correcciones necesarias:
-- 1. Sincronización NO afecta estado/sector
-- 2. Unificación solo se ejecuta en "Finalizado en Taller"
-- ============================================
