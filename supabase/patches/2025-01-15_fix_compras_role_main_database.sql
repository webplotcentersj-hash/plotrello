-- Asegurar que el rol compras esté completamente configurado en la base de datos principal
-- Esta migración debe ejecutarse en: https://bwdtrzcdzbzrtykjzber.supabase.co

-- 1. Actualizar el constraint de la tabla usuarios para incluir compras
...
-- 2. Actualizar la función crear_usuario para incluir compras
...
BEGIN
  -- Validación de rol con compras incluido
  IF p_rol NOT IN (
    'administracion',
    'gerencia',
    'diseno',
...
-- 3. Crear el usuario fbergaglio@plotcenter.com.ar con rol compras
INSERT INTO public.usuarios (nombre, password_hash, rol)
VALUES (
