-- Notificar asesor técnico / presupuestos cuando el tótem solicita asesor (sector Asesor o marcador en notas).
...
BEGIN
  ...
  IF v_es_solicitud_asesor THEN
    FOR v_user IN
      ...
      WHERE rol IN ('asesor-tecnico', 'presupuestos', 'mostrador', 'administracion')
    LOOP
...
COMMENT ON FUNCTION public.crear_atencion_mostrador IS
  'Crea atención de mostrador; chat interno; notifica por sector. Solicitud asesor (tótem) notifica asesor-tecnico/presupuestos.';
