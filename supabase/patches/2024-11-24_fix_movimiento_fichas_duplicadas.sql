-- ============================================
-- FIX: Las fichas duplicadas no se mueven - vuelven al estado anterior
-- 
-- Problema: Algún trigger está revirtiendo los cambios de estado
-- Solución: Asegurar que los triggers NO interfieran con el movimiento
-- ============================================

BEGIN;

-- ============================================
-- PASO 1: Verificar y corregir función de sincronización
...
-- ============================================
-- PASO 3: Verificar que no haya otros triggers que reviertan cambios
-- ============================================
-- El trigger de unificación solo debe ejecutarse cuando TODAS las fichas
-- están en "Finalizado en Taller", no en cada movimiento

-- ============================================
-- PASO 4: Asegurar que el trigger de unificación NO interfiera
-- ============================================
