-- Comprobante de pago: datos extraídos por PlotAI (JSON + texto legible).

ALTER TABLE public.ventas
  ADD COLUMN IF NOT EXISTS comprobante_pago_ia jsonb,
  ADD COLUMN IF NOT EXISTS comprobante_pago_texto text;

COMMENT ON COLUMN public.ventas.comprobante_pago_ia IS 'Datos estructurados del comprobante (PlotAI).';
COMMENT ON COLUMN public.ventas.comprobante_pago_texto IS 'Resumen legible del comprobante extraído por PlotAI.';
