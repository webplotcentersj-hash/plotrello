-- ============================================
-- Fix: Corregir función convertir_pedido_a_op
-- Problemas:
-- 1. Ambiguidad en numero_op (línea 513)
-- 2. Referencia a clientes_web en lugar de clientes unificado
-- ============================================
...
BEGIN
  ...
  INSERT INTO public.ordenes_trabajo (
    ...
    p_id_pedido,
    true,
    COALESCE(pedido_record.observaciones_internas, '') || E'\nConvertido desde pedido web ' || pedido_record.numero_pedido || ' por ' || p_nombre_usuario_convertidor || ' el ' || CURRENT_TIMESTAMP::text
  )
...
COMMENT ON FUNCTION public.convertir_pedido_a_op IS 'Convierte un pedido de cliente en una OP (corregido para usar tabla clientes unificada)';
