-- Comprobante de pago adjunto a ventas (URL en Storage u otro origen).
BEGIN;

ALTER TABLE public.ventas
  ADD COLUMN IF NOT EXISTS comprobante_pago_url text;

COMMENT ON COLUMN public.ventas.comprobante_pago_url IS 'URL del comprobante de pago (transferencia, etc.) subido desde venta rápida o CRM.';
