...
```sql
-- Asegurar que el rol recursos-humanos esté completamente configurado
BEGIN;

-- 1. Actualizar el constraint de la tabla usuarios para incluir recursos-humanos
...
-- 2. Actualizar la función crear_usuario para incluir recursos-humanos
...
El rol `recursos-humanos` ya debería estar incluido en la base de datos según las migraciones anteriores, pero este script asegura que esté completamente configurado y actualizado.
