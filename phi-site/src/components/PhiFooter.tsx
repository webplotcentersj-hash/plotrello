      ...
      <div className="phi-container">
        <div className="phi-footer-newsletter">
          ...
          <div className="phi-footer-newsletter-box">
            ...
            <a href={plotLabPath('/postulacion-operarios')} className="phi-btn phi-btn--dark">
        ...
        <div className="phi-footer-grid">
          ...
          <div>
            ...
            <ul>
              <li>
                <a href={plotLabPath('/postulacion-operarios')}>Postulación operarios</a>
              </li>
              <li>
                <a href={plotLabPath('/login')}>Ingreso staff / diseñador</a>
              </li>
              <li>
                <a href={plotLabPath('/operario-externo/diseno')}>Panel diseñador externo</a>
              </li>
            </ul>
          </div>
