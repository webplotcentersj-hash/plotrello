...
function tipoLabel(t: TipoDocumento): string {
  if (t === 'protocolo') return 'Protocolo'
      ...
      <div className="protocolos-bases-inner">
        <header className="protocolos-bases-hero">
          ...
          <div className="protocolos-bases-hero-row">
            ...
            <div className="protocolos-bases-title-block">
              ...
              <p className="protocolos-bases-lead">Documentos para que el equipo trabaje con el mismo criterio.</p>
            </div>
          </div>
        </header>
        ...
        {canUpload && (
          <section className="protocolos-bases-upload">
            <div className="protocolos-bases-section-head">
              <div>
                <h2 className="protocolos-bases-h2">Subir o generar</h2>
                <p className="protocolos-bases-section-desc">Archivo o borrador con PlotAI; mismo criterio para todo el equipo.</p>
              </div>
              <div className="protocolos-bases-segment" role="group" aria-label="Modo de carga">
                <button
                  type="button"
        ...
        <section className="protocolos-bases-library">
          <div className="protocolos-bases-section-head protocolos-bases-section-head--library">
            <div>
              ...
              <p className="protocolos-bases-section-desc">Buscá por título, categoría, etiquetas o nombre de archivo.</p>
            </div>
          </div>
          ...
          {filtered.length === 0 ? (
            <div className="protocolos-bases-empty">
              ...
              <p className="protocolos-bases-empty-title">Sin resultados</p>
              <p className="protocolos-bases-empty-text">No hay documentos que coincidan con la búsqueda o el filtro.</p>
            </div>
          ) : (
            <div className="protocolos-bases-list">
              {filtered.map((doc) => {
                ...
                const tipoClass =
                  tipo === 'protocolo' ? 'protocolos-bases-type--protocolo' : tipo === 'base' ? 'protocolos-bases-type--base' : 'protocolos-bases-type--otro'
                return (
                  <div key={doc.id} className="protocolos-bases-card" data-tipo={doc.tipo}>
                    ...
                    <div className="protocolos-bases-card-inner">
                      <div className="protocolos-bases-card-main">
                        <div className="protocolos-bases-card-top">
                          <span className={`protocolos-bases-type ${tipoClass}`}>{tipoLabel(tipo)}</span>
                        ...
                        {doc.categoria ? <p className="protocolos-bases-card-cat">{doc.categoria}</p> : null}
                        {!!doc.tags?.length && (
