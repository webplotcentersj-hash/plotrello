    ...
    <div className="modal-overlay" onClick={() => onClose(task?.id)}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          {/* IMPORTANTE: Renderizar siempre el componente para mantener consistencia en hooks */}
          {/* BriefLinkSection maneja su propia validación de permisos y retorna null si no tiene acceso */}
          {(isAdmin || isDiseno) && (
